	...
	public function __construct( $parent, $post_type = '', $plural = '', $single = '', $description = '', $options = array() ) {
		...
		$this->settings = array(
			...
			'fields' => array(
				...
				'super_simple_slider_type' => array(
					'label'			=> __( 'Theme Type', 'super-simple-slider' ),
					'type'			=> 'select',
					'suffix'		=> 'ms',
					'class'			=> 'full-width',
					'options' => array(
						...
						'Slider 2' => 'slider2',
						'Slider 3' => 'slider3',
						'EdgeOps Enterprise' => 'edgeops_enterprise',
						'EdgeOps Platform' => 'edgeops_platform',
						'Solutions EdgeOps Bring' => 'solutions_edgeops_bring',
						'Solutions Industry' => 'solutions_industry',
						'Solutions Industry Slider' => 'solutions_industry_slider',
						'Product Slider 1' => 'product_slider_1',
						'Product Slider 2' => 'product_slider_2',
						'Product Product Featured' => 'product_product_featured_slider',
						'Product Benefits Across the Organization' => 'product_benefits_across_the_organization',
						'Product Data Driven' => 'product_data_driven',
						'Developer Site Mesh Flexx' => 'developer_site_mesh_flexx',
						'Developer Resiliency Reliable Quality' => 'developer_resiliency_reliable_quality',
						'Developer EdgeOps Technology' => 'developer_edgeops_technology',
						),
					'description' => __( 'Different types of slider', 'super-simple-slider' )
				)
			)
		);
		...
		$this->repeatable_fieldset_settings = array(
			...
			'fields' => array(
				...
				'super_simple_slider_slide_text_2' => array(
					'type'			=> 'html',
					'placeholder'	=> __( 'Text', 'super-simple-slider' ),
					'class'			=> '',
					'description'	=> ''
				),
				'super_simple_slider_slide_company' => array(
					'type'			=> 'text',
					'placeholder'	=> __( 'Company', 'super-simple-slider' ),
					'class'			=> '',
					'description'	=> ''
				),				
				...
				'super_simple_slider_slide_bgimage' => array(
		...
		add_action( 'save_post', array( $this, 'save_global_settings_meta' ) );
