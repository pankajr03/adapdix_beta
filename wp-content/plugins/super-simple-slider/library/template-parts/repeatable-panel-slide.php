	...
	<td class="width-65 no-padding">
		...
		<div class="otb-tabs-container">
			...
			<div class="tab-content content active">
				...
				<?php $this->create_super_simple_form_control( 'super_simple_slider_slide_text_2', $this->repeatable_fieldset_settings ); ?>
				<?php $this->create_super_simple_form_control( 'super_simple_slider_slide_company', $this->repeatable_fieldset_settings ); ?>
			...
			<div class="tab-content styling">
				...
				<ul class="fieldset">
					...
					<li>
						<?php $this->create_super_simple_form_control( 'super_simple_slider_slide_bgimage', $this->repeatable_fieldset_settings ); ?>
