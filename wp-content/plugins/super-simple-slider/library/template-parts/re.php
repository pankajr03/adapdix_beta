		...
		<div class="">
			<div class="custom-container">
				<div class="row ">
					<div class="col-md-12">
						<div class="hide-dt">
							<div class="sider-nav-partner" id="sider-nav-partner-<?php echo $slider_id;?>">
							...
							<div class="sider-for-partner" id="sider-for-partner-<?php echo $slider_id;?>">
...
<script>
   ...
   jQuery(document).ready(function(){
	jQuery('#sider-nav-partner-<?php echo $slider_id?>').slick({
	  slidesToShow: 2,
	  slidesToScroll: 1,
	  asNavFor: '#sider-for-partner-<?php echo $slider_id?>',
	  arrows: false,
	  centerMode: true,
	  focusOnSelect: true
	});
	
	jQuery('#sider-for-partner-<?php echo $slider_id?>').slick({
		slidesToShow: 1,
		slidesToScroll: 1,
	    dots: true,
	    arrows: false,
		fade: true,
		asNavFor: '#sider-nav-partner-<?php echo $slider_id?>'
});
