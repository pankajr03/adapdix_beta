...
function Update_EWD_FEUP_Options() {
	...
	if (($EWD_FEUP_Full_Version == "Yes" or $First_Install_Version <= 2.6) and isset($_POST['feup_label_level_select_message'])) {update_option("EWD_FEUP_Label_Level_Select_Message", $_POST['feup_label_level_select_message']);}
