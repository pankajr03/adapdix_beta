...
<strong>Includes Gutenberg blocks for the following features: register, login, logout, user search, user list, edit account, forgot password and confirm forgot password!</strong>
...
* Our documentation, here: https://www.etoilewebdesign.com/suppot-center/?Plugin=FEUP&Type=FAQs
