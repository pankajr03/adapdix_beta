		...
		<div class="custom-container">
			...
			<div class="row">
				...
				<div class="col-md-12 filters">
					<div class="filter-display mb-4">Filter By: <span class="all-type pl-2" id="alltypes"> All Types </span> <button class=" btn primary-color filterreset" id="all">Reset</button></div>
						<div class="filter-types mb-5" id="filtertypes" style="display: none;">
							...
							<?php foreach ($pgafuterms as $term_id => $term_name) { ?>
								<button class="btn filterbtns" id="<?php echo $term_id; ?>"><?php echo $term_name; ?></button>
							<?php } ?>
						</div>
					</div>
				</div>
			...
			<div>
				...
				<?php while ($post_query->have_posts()) : $post_query->the_post();
					...
					$cat_term_id = $postcats[0]->term_id;
