<?php
/**
 * OLWS_Msg91_International_Api class.
 *
 * The class names need to defined in format: OLWS_%s_Api, where %s means Api name, e.g. OLWS_Msg91_International_Api
...
/**
 * Class OLWS_Msg91_International_Api
 */
class OLWS_Msg91_International_Api {
	...
	/**
	 * Send the OTP via MSG91 International api
	 *
	...
	public function olws_send_otp( $phone, $country_code ) {
		...
		$api_url = 'http://world.msg91.com/api/otp.php';
	...
	public function olws_verify_otp( $phone, $country_code, $otp, $res_param ) {
		...
		$api_url = 'http://world.msg91.com/api/verifyRequestOTP.php';
