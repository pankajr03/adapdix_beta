...
<div class="row">
		...
		<div class="panel panel-primary panel-default content-panel about_us_section ">
			<div class="panel-body">
				<table class="form-table">
					...
					<tr class="radio-span" style="border-bottom:none;">
						<td>
							<input type="text" class="pro_text" id="about_btn_label" name="about_btn_label" placeholder="<?php _e('Enter About Us button text','WPSM_RCS_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_attr($wpsm_rcs_plugin_options_about_us['about_btn_label']); ?>" />
						</td>
					</tr>
				</table>
			</div>
		...
		<div class="panel panel-primary panel-default content-panel about_us_section">
			<div class="panel-body">
				<table class="form-table">
					...
					<tr class="radio-span" style="border-bottom:none;">
						<td>
							<input type="text" class="pro_text" id="about_section_title" name="about_section_title" placeholder="<?php _e('Enter About Us Section Title','WPSM_RCS_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_textarea(stripslashes($wpsm_rcs_plugin_options_about_us['about_section_title'])); ?>" />
						</td>
					</tr>
				</table>
			</div>
		...
		<div class="panel panel-primary panel-default content-panel about_us_section">
			<div class="panel-body">
				<table class="form-table">
					...
					<tr class="radio-span" style="border-bottom:none;">
						<td>
							<textarea rows="6"  class="pro_text" id="about_section_desc" name="about_section_desc" placeholder="<?php _e('Enter Your About Us Section Description Here...','WPSM_RCS_TEXT_DOMAIN'); ?>"><?php echo esc_textarea(stripslashes($wpsm_rcs_plugin_options_about_us['about_section_desc'])); ?></textarea>
						</td>
					</tr>
					<tr class="radio-span" style="border-bottom:none;">
						<td >
	...
	<div class="panel panel-primary save-button-block">
		...
		<div class="panel-body">
			<div class="pull-left">
				<button type="button" class="btn btn-info btn-lg" onclick="wpsm_rcs_option_data_save('about_us','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Save Changes','WPSM_RCS_TEXT_DOMAIN'); ?></button>
			</div>
			<div class="pull-right">
				<button type="button" class="btn btn-primary btn-lg" onclick="wpsm_rcs_option_data_reset('about_us','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Reset Default','WPSM_RCS_TEXT_DOMAIN'); ?></button>
			</div>
		</div>
	</div>	
