...
<div class="row">
					...
					<table class="form-table">
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td>
								...
								<input type="text" class="pro_text" id="to_subs_mail_sub" name="to_subs_mail_sub" placeholder="<?php _e('Enter subject Here For After Subscriber Confirmation Mail','WPSM_RCS_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_attr($wpsm_rcs_plugin_options_newsletter['to_subs_mail_sub']); ?>" />
							</td>
						</tr>
						<tr class="" style="border-bottom:none;">
							<td>
								<p class="rcsp_p_admin"><?php _e('Message Body','WPSM_RCS_TEXT_DOMAIN'); ?></p>
								<textarea rows="6"  class="pro_text" id="to_subs_mail_msg" name="to_subs_mail_msg" placeholder="<?php _e('Enter Your Message Here For After Subscriber Confirmation Mail','WPSM_RCS_TEXT_DOMAIN'); ?>"><?php echo esc_textarea(stripslashes($wpsm_rcs_plugin_options_newsletter['to_subs_mail_msg'])); ?></textarea>
							</td>
						</tr>
				...
				<div class="panel-body">
					<table class="form-table">
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td>
								<p class="rcsp_p_admin"><?php _e('Subject','WPSM_RCS_TEXT_DOMAIN'); ?></p>
								<input type="text" class="pro_text" id="to_admin_mail_sub" name="to_admin_mail_sub" placeholder="<?php _e('Enter subject for notification mail','WPSM_RCS_TEXT_DOMAIN')?>" size="56" value="<?php echo esc_attr($wpsm_rcs_plugin_options_newsletter['to_admin_mail_sub']); ?>" />
							</td>
						</tr>
						<tr class="" style="border-bottom:none;">
							<td>
								<p class="rcsp_p_admin"><?php _e('Message Body','WPSM_RCS_TEXT_DOMAIN'); ?></p>
								<textarea rows="6"  class="pro_text" id="to_admin_mail_msg" name="to_admin_mail_msg" placeholder="<?php _e('Enter your message for notification mail','WPSM_RCS_TEXT_DOMAIN')?>"><?php echo esc_textarea(stripslashes($wpsm_rcs_plugin_options_newsletter['to_admin_mail_msg'])); ?></textarea>
							</td>
						</tr>
	...
	<div class="panel panel-primary save-button-block">
		...
		<div class="panel-body">
			...
			<div class="pull-left">
				<button type="button" class="btn btn-info btn-lg" onclick="wpsm_rcs_option_data_save('newsletter','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Save Changes','WPSM_RCS_TEXT_DOMAIN'); ?></button>
			</div>
			<div class="pull-right">
				<button type="button" class="btn btn-primary btn-lg" onclick="wpsm_rcs_option_data_reset('newsletter','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Reset Default','WPSM_RCS_TEXT_DOMAIN'); ?></button>
			</div>
		</div>
	</div>
