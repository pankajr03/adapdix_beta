				...
				<div class="col-md-6  demoftr "> 
					<div class="">
						<div class="wpsme_home_portfolio_showcase">
							...
							<?php } else{ ?>
								<div class="wpsm_ribbon"><a target="_blank" href="https://wpshopmart.com/plugins/coming-soon-pro/"><span>Availabe In pro</span></a></div>
					...
					<div style="padding:13px;overflow:hidden;">
						...
						<a  href="https://wpshopmart.com/coming-soon-pro-demo-page/#csp-<?php echo $i; ?>" target="_blank" class="demo-csp-btn" >View Demo </a>
						<?php if($i!=1) { ?>
						<a  href="https://wpshopmart.com/plugins/coming-soon-pro/" target="_blank" class="demo-csp-btn2" >Upgrade Now </a>
						<?php } ?>
						</div>
					</div>			
				</div>
