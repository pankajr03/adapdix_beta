...
<div class="row" class="">
			...
			<div class="panel-body">
				<table class="form-table">
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="headeline_ft_clr" name="headeline_ft_clr" type="text" value="<?php echo esc_attr($wpsm_rcs_plugin_options_text_and_color['headeline_ft_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="desc_ft_clr" name="desc_ft_clr" type="text" value="<?php echo esc_attr($wpsm_rcs_plugin_options_text_and_color['desc_ft_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="sb_btn_ft_clr" name="sb_btn_ft_clr" type="text" value="<?php echo esc_attr($wpsm_rcs_plugin_options_text_and_color['sb_btn_ft_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="sb_btn_bg_clr" name="sb_btn_bg_clr" type="text" value="<?php echo esc_attr($wpsm_rcs_plugin_options_text_and_color['sb_btn_bg_clr']); ?>" class="my-color-field" data-default-color="#16c9d0" />
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="cnd_timer_clr" name="cnd_timer_clr" type="text" value="<?php echo esc_attr($wpsm_rcs_plugin_options_text_and_color['cnd_timer_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="social_icon_clr" name="social_icon_clr" type="text" value="<?php echo esc_attr($wpsm_rcs_plugin_options_text_and_color['social_icon_clr']); ?>" class="my-color-field" data-default-color="#333333" />
						</td>
					</tr>
				</table>
			</div>
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="social_icon_bg_clr" name="social_icon_bg_clr" type="text" value="<?php echo esc_attr($wpsm_rcs_plugin_options_text_and_color['social_icon_bg_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="ext_ft_clr" name="ext_ft_clr" type="text" value="<?php echo esc_attr($wpsm_rcs_plugin_options_text_and_color['ext_ft_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
			...
			<div class="panel-body">
				<table class="form-table">
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="ext_bg_clr" name="ext_bg_clr" type="text" value="<?php echo esc_attr($wpsm_rcs_plugin_options_text_and_color['ext_bg_clr']); ?>" class="my-color-field" data-default-color="#16c9d0" />
			...
			<div class="panel-body">
				<table class="form-table">
					...
					<tr class="radio-span" style="border-bottom:none;">
						<td >
							<h4>Unlock More 500+ Google Fonts In pro version <a href="https://wpshopmart.com/plugins/coming-soon-pro/" target="_blank">Buy Now</a></h4>
						</td>
					</tr>
				</table>
			</div>
	...
	<div class="panel panel-primary save-button-block">
		<input type="hidden" id="security" name="security" value="<?php echo $csp_security_action_nonce; ?>" />
		<div class="panel-body">
			<div class="pull-left">
				<button type="button" class="btn btn-info btn-lg" onclick="wpsm_rcs_option_data_save('text_and_color','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Save Changes','WPSM_RCS_TEXT_DOMAIN'); ?></button>
			</div>
			<div class="pull-right">
				<button type="button" class="btn btn-primary btn-lg" onclick="wpsm_rcs_option_data_reset('text_and_color','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Reset Default','WPSM_RCS_TEXT_DOMAIN'); ?></button>
			</div>
		</div>
	</div>
