...
<div class="row">
				...
				<div class="panel-body">
					<table class="form-table">
						...
						<tr  style="border-bottom:none;">
							<td>
								<input id="background_color" name="background_color" type="text" value="<?php echo esc_attr($wpsm_rcs_plugin_options_background['background_color']); ?>" class="my-color-field" data-default-color="#ffffff" />
							...
							<td>
								<div class="col-md-6">
									<div class="rcsp-image-entry" >
										...
										<input type="text" id="background_image" name="background_image" class="rcsp_label_text"  value="<?php echo esc_url($wpsm_rcs_plugin_options_background['background_image']); ?>"  readonly="readonly" placeholder="<?php _e('No Media Selected','WPSM_RCS_TEXT_DOMAIN'); ?>" />
									</div>
								</div>
							</td>
						</tr>
			...
			<div class="panel panel-primary panel-default content-panel">
				<div class="panel-body">
					<table class="form-table">
							...
							?>
								<div class="col-md-4 rscp_slides_bg" id="rcsp_sl_bg_<?php echo $i; ?>" style="display:<?php if($bg_slideshow_no=="1"){echo "none";}elseif($i > ($bg_slideshow_no-1)) echo "none";?>" >
									...
									<div class="rcsp-image-entry" >
										...
										<input type="button"  name="upload-background" value="Upload Image Here" class="button-primary rcsp_media_upload"  />
										<input type="text" id="background_slides_<?php echo $i; ?>" name="background_slides_<?php echo $i; ?>" class="rcsp_label_text"  value="<?php echo esc_url($wpsm_rcs_plugin_options_background['background_slides_'.$i]); ?>"  readonly="readonly" placeholder="<?php _e('No Media Selected','WPSM_RCS_TEXT_DOMAIN'); ?>" value="" />
									</div>
								</div>
							<?php } ?>	
							</td>
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td >
								<h4>Unlock More 5+ background Slides In pro version <a href="https://wpshopmart.com/plugins/coming-soon-pro/" target="_blank">Buy Now</a></h4>
							</td>
						</tr>
	...
	<div class="panel panel-primary save-button-block">
		...
		<div class="panel-body">
			...
			<div class="pull-left">
				<button type="button" class="btn btn-info btn-lg" onclick="wpsm_rcs_option_data_save('background','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Save Changes','WPSM_RCS_TEXT_DOMAIN'); ?></button>
			</div>
			<div class="pull-right">
				<button type="button" class="btn btn-primary btn-lg" onclick="wpsm_rcs_option_data_reset('background','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Reset Default','WPSM_RCS_TEXT_DOMAIN'); ?></button>
			</div>
		</div>
	</div>							
</div>