...
<Script>
	...
	<div class="row">
							...
							<td>								
								<div class="col-md-6">
									<div class="rcsp-image-entry" >
										...
										<input type="text" id="rcsp_logo_url" name="rcsp_logo_url" class="rcsp_label_text"  value="<?php echo esc_url($wpsm_rcs_plugin_options_general['rcsp_logo_url']); ?>"  readonly="readonly" placeholder="No Media Selected" />
									</div>
								</div>
							</td>
						</tr>
			...
			<div class="panel panel-primary panel-default content-panel">
				<div class="panel-body">
					<table class="form-table">
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td>
								<input type="text" class="pro_text" id="rcsp_headline" name="rcsp_headline" placeholder="<?php _e('Site coming soon!','WPSM_RCS_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_textarea(stripslashes($wpsm_rcs_plugin_options_general['rcsp_headline'])); ?>" />
							</td>
						</tr>
					</table>
				</div>
			...
			<div class="panel panel-primary panel-default content-panel">
				<div class="panel-body">
					<table class="form-table">
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td>
								<textarea rows="6"  class="pro_text" id="rcsp_description" name="rcsp_description" placeholder="<?php _e('Enter Your Coming Soon Description Here...','WPSM_RCS_TEXT_DOMAIN'); ?>"><?php echo esc_textarea(stripslashes($wpsm_rcs_plugin_options_general['rcsp_description'])); ?></textarea>
			...
			<div class="panel panel-primary panel-default content-panel">
				<div class="panel-body">
					<table class="form-table">
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td>
								<input type="text" class="pro_text" id="home_sec_link_txt" name="home_sec_link_txt" size="56" value="<?php echo esc_attr($wpsm_rcs_plugin_options_general['home_sec_link_txt']); ?>" />
							</td>
						</tr>
					</table>
				</div>
		...
		<div class="panel panel-primary save-button-block">
			...
			<div class="panel-body">
				<div class="pull-left">
					<button type="button" class="btn btn-info btn-lg" onclick="wpsm_rcs_option_data_save('general','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Save Changes','WPSM_RCS_TEXT_DOMAIN'); ?></button>
				</div>
				<div class="pull-right">
					<button type="button" class="btn btn-primary btn-lg" onclick="wpsm_rcs_option_data_reset('general','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Reset Default','WPSM_RCS_TEXT_DOMAIN'); ?></button>
				</div>
			</div>
		</div>							
