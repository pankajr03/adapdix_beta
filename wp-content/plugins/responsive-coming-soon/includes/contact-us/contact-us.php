...
<!----------------------------------------> 
	...
	<div class="row">
			...
			<div class="panel panel-primary panel-default content-panel contact_us_section">
				<div class="panel-body">
					<table class="form-table">
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td>
								<input type="text" class="pro_text" id="contact_us_section_btn_label" name="contact_us_section_btn_label" placeholder="<?php _e('Enter Contact Us button text','WPSM_RCS_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_attr($wpsm_rcs_plugin_options_contact_us['contact_us_section_btn_label']); ?>" />
							</td>
						</tr>
					</table>
				</div>
			...
			<div class="panel panel-primary panel-default content-panel contact_us_section">
				<div class="panel-body">
					<table class="form-table">
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td>
								<input type="text" class="pro_text" id="contact_us_section_title" name="contact_us_section_title" placeholder="<?php _e('Enter Contact Us section Title Here','WPSM_RCS_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_textarea(stripslashes($wpsm_rcs_plugin_options_contact_us['contact_us_section_title'])); ?>" />
							</td>
						</tr>
					</table>
				</div>
			...
			<div class="panel panel-primary panel-default content-panel contact_us_section">
				<div class="panel-body">
					<table class="form-table">
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td>
								<textarea rows="6"  class="pro_text" id="contact_us_section_title_desc" name="contact_us_section_title_desc" placeholder="<?php _e('Enter Your Contact Us Section Description Here...','WPSM_RCS_TEXT_DOMAIN'); ?>"><?php echo esc_textarea(stripslashes($wpsm_rcs_plugin_options_contact_us['contact_us_section_title_desc'])); ?></textarea>
							</td>
						</tr>
					</table>
				</div>
					...
					<table class="form-table">
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td>
								...
								<input type="text" class="pro_text" id="contact_info_address" name="contact_info_address" placeholder="<?php _e('Enter Your Address Here','WPSM_RCS_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_attr($wpsm_rcs_plugin_options_contact_us['contact_info_address']); ?>" />
							</td>
						</tr>
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td>
								...
								<input type="text" class="pro_text" id="contact_info_number" name="contact_info_number"  size="56" value="<?php echo esc_attr($wpsm_rcs_plugin_options_contact_us['contact_info_number']); ?>" />
							</td>
						</tr>
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td>
								...
								<input type="text" class="pro_text" id="contact_info_email_address" name="contact_info_email_address" placeholder="<?php _e('Enter Your Contact Email For display on Contact Info Section','WPSM_RCS_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_attr($wpsm_rcs_plugin_options_contact_us['contact_info_email_address']); ?>" />
							</td>
						</tr>
		...
		<div class="panel panel-primary save-button-block">
			...
			<div class="panel-body">
				<div class="pull-left">
					<button type="button" class="btn btn-info btn-lg" onclick="wpsm_rcs_option_data_save('contact_us','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Save Changes','WPSM_RCS_TEXT_DOMAIN'); ?></button>
				</div>
				<div class="pull-right">
					<button type="button" class="btn btn-primary btn-lg" onclick="wpsm_rcs_option_data_reset('contact_us','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Reset Default','WPSM_RCS_TEXT_DOMAIN'); ?></button>
				</div>
			</div>
		</div>
