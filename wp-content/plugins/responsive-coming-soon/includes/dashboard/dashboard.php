...
<div class="row">
			...
			<div class="panel-body">
				<table class="form-table">
					...
					<tr class="radio-span" style="border-bottom:none;">
						...
						<a style="color:#fff" class="btn btn-danger btn-lg " href="https://www.youtube.com/c/wpshopmart?sub_confirmation=1" target="_blank">Subscribe Our Channel</a>
						<a class="btn btn-success btn-lg " style="color:#fff" href="https://www.youtube.com/c/wpshopmart" target="_blank">Check More Helping Videos</a>
							</div>	
	...
	<div class="panel panel-primary save-button-block">
		...
		<div class="panel-body">
			<div class="pull-left">
				<button type="button" class="btn btn-info btn-lg" onclick="wpsm_rcs_option_data_save('dashboard','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Save Changes','WPSM_RCS_TEXT_DOMAIN'); ?></button>
			</div>
			<div class="pull-right">
				<button type="button" class="btn btn-primary btn-lg" onclick="wpsm_rcs_option_data_reset('dashboard','<?php echo $csp_security_action_nonce; ?>')"><?php _e('Reset Default','WPSM_RCS_TEXT_DOMAIN'); ?></button>
			</div>
		</div>
	</div>
