...
/*
* default data load for coming soon page
*/
...
function wpsm_responsive_coming_soon_menu()
{
    ...
    //add hook to add styles and scripts for coming soon backned panel page
...
{  
	$csp_security_action_nonce = wp_create_nonce("csp_security_action_nonce");
