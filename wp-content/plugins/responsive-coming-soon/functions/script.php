...
function wpsm_responsive_coming_soon_plugin_js_css()
{
	...
	// Bootstrap Js
	wp_enqueue_script('wpsm_rcs-popper',WPSM_RCS_PLUGIN_URL.'js/popper.js');
...
<a style="    color: #fff;
    ...
    border-radius: 4px;
    margin-left: 10px;
    text-decoration: none;" href="https://wpshopmart.com/plugins/coming-soon-pro/" class="btn btn-primary" target="_blank" rel="noopener"><?php _e( 'Check Coming Soon Pro Plugin', '' ); ?></a>
			</p>
	</div>
