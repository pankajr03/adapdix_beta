...
while ( have_posts() ) :
	...
	<div class="section-hp sm-section-p pb-0 hide-m">
		<div class="custom-container">
			<div class="row">
				...
				?>
					<h1 class="mb-4 big-heading"><?php the_title(); ?> </h2>
				...
				if ( empty( $_GET['team'] ) || ( ! empty( $member_info['sptp_job_title'] ) ) && in_array( 'position', $detail_fields, true ) ) :
					?>
					<p class="lead mb-4"><?php echo esc_html( $member_info['sptp_job_title'] ); ?></p>
						...
						<?php if ( empty( $_GET['team'] ) || in_array( 'img', $detail_fields ) ) { ?>
							...
							if ( has_post_thumbnail() ) {
								...
								if ( ! empty( $member_info['member_image_gallery'] ) ) {
									...
									echo "<img src='" . $gallery_attachment[0] . "' class='img-fluid' />";
								} else {
									echo "<img src='" . SPT_PLUGIN_ROOT . "/public/img/Placeholder-Image.png' class='img-fluid' />";
								}
							}
						}
						?>
	...
	<div class="section-hp sm-section-p pb-0 hide-dt">
		<div class="custom-container">
			<div class="row">
