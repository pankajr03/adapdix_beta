	...
	class SPF {
		...
		public static function add_admin_enqueue_scripts() {
			...
			if ( ( 'sptp_member' === get_post_type() ) || ( 'sptp_member_page_team_help' === $screen->id ) || ( 'sptp_member_page_team_settings' === $screen->id ) || ( 'sptp_generator' === get_post_type() ) || ( 'edit-sptp_group' === $screen->id ) ) {
				...
				wp_enqueue_style( 'spf', SPT_PLUGIN_ROOT . 'admin/partials/shapedplugin-framework/assets/css/spf.min.css', array(), '2.0', 'all' );

				// rtl styles
				if ( is_rtl() ) {
					wp_enqueue_style( 'spf-rtl', SPT_PLUGIN_ROOT . 'admin/partials/shapedplugin-framework/assets/css/spf-rtl.min.css', array(), '2.0', 'all' );
				}

				// framework core scripts
				wp_enqueue_script( 'spf-plugins', SPT_PLUGIN_ROOT . 'admin/partials/shapedplugin-framework/assets/js/spf-plugins.min.js', array(), '2.0', true );
				wp_enqueue_script( 'spf', SPT_PLUGIN_ROOT . 'admin/partials/shapedplugin-framework/assets/js/spf.min.js', array( 'spf-plugins' ), '2.0', true );
