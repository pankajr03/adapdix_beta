...
The most versatile and industry-leading WordPress team plugin built to display unlimited teams easily in minutes. Customizable - No coding required!
...
[__Live Demo__](https://shapedplugin.com/demo/wp-team/) | [__Documentaion__](https://shapedplugin.com/docs/docs/wp-team/) | [__Support__](https://shapedplugin.com/support-forum/ask-question/) | [__Upgrade to Pro!__](https://shapedplugin.com/plugin/wp-team-pro/)
...
If you have any question about working with WP Team, you can take a look at online [__documentation__](https://shapedplugin.com/docs/docs/wp-team/).


= For Fast Support, and Bug Reporting =

We are very responsive about support requests – so if you face a problem or find any bugs, post it in the [support forum](https://shapedplugin.com/support-forum/), and we will respond within 15 hours (except holidays).

>Ask us at either via our [Support Forum](https://shapedplugin.com/support-forum/) or [WordPress.org](https://wordpress.org/support/plugin/team-free/)
...
You can get access to more features when you purchase a license of the plugin. Purchasing a license of [WP Team Pro](https://shapedplugin.com/plugin/wp-team-pro/) gets you to access the full version of WP Team, automatic lifetime updates, and support.

=What if I upgrade to premium version?=
Your existing team members content will work with [premium version](https://shapedplugin.com/plugin/wp-team-pro/). So you won’t lose your developed contents.
...
If you find a bug, please report it in our active [support forum](https://shapedplugin.com/support-forum/). You will be replied once the issue is resolved.
