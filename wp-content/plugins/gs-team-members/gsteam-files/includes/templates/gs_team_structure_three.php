			...
			while ( $GLOBALS['gs_team_loop']->have_posts() ) {
				...
				$output .= '<div class="col-md-'.$cols.' col-sm-6 col-xs-6 cbp-so-section single-member-div">';
					...
					$output .= '<div class="single-member">'; // start single meember
						...
						$output .= '<div class="col-md-6 cbp-so-side cbp-so-side-left">'; // Right side
							...
							$output .= '<div class="single-mem-desc-social">'; // start desc & social
								...
								endif; // gs_member_connect
							
							$output .= '</div>'; // end desc & social
						$output .= '</div>'; // left side

						$output .= '<div class="col-md-6 cbp-so-side cbp-so-side-right">'; // left side
