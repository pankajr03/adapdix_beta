		...
		while ( $GLOBALS['gs_team_loop']->have_posts() ) {
			...
			$output .='<div class="col-md-12 cbp-so-section">';
				...
				$output .='<div class="row">';
					...
					$output .='<div class=" col-md-8  col-sm-8 col-xs-12 cbp-so-side cbp-so-side-left gstm-img-div">
					...
					$output .='<div class="col-md-4 col-sm-4 col-xs-12 cbp-so-side cbp-so-side-right gstm-img-div">
