...
add_action('admin_menu', 'gs_team_help_menu');

function gsteam_help_menu_cb() {
	?>

    <div class="gsp-wrap">
        
    	<div class="gs_team_wrap gs_team_help" style="width: 845px; float: left; margin-top: 20px; text-align: center;">
	        <h1>GS Team Members by GS Plugins</h1>
			<div class="help-link">
    			<a class="gstm-hlp-btn gstm-btn-1" href="https://gsplugins.com/product/gs-team-members" target="_blank">Plugin Home</a>
    			<a class="gstm-hlp-btn gstm-btn-2" href="http://team.gsplugins.com" target="_blank">Live Demo</a>
    			<a class="gstm-hlp-btn gstm-btn-3" href="http://team.gsplugins.com/documentation" target="_blank">Documentation</a>
    			<a class="gstm-hlp-btn gstm-btn-4" href="http://team.gsplugins.com/documentation/#GS_Team_Member8217s_shortcode_usage" target="_blank">Shortcode Usage</a>
