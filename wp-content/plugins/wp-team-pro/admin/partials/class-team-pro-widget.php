 ...
 */
class WPTeamPro_Widget extends WP_Widget {
	/**
	 * Sets up the widgets name etc
	 */
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'wpteampro_widget',
			'description' => 'WP Team Pro Widget',
		);
		parent::__construct( 'wpteampro_widget', 'WP Team Pro Widget', $widget_ops );
	}
