 ...
 * @version 2.0.0
 */
if ( ! class_exists( 'SPF_Customize_Options' ) ) {
	class SPF_Customize_Options extends SPF_Abstract {
		...
		public function add_customize_options( $wp_customize ) {
			...
			if ( ! class_exists( 'WP_Customize_Panel_SPF' ) ) {
				SPF::include_plugin_file( 'functions/customize.php' );
			}
