...
(function($) {
  ...
  function SPFAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  SPFAjaxChosen.prototype.init = function() {
  ...
  SPFAjaxChosen.prototype.events = function() {
  ...
  SPFAjaxChosen.prototype.search_field_focused = function() {
  ...
  SPFAjaxChosen.prototype.search_welcome_message = function() {
  ...
  SPFAjaxChosen.prototype.update_list = function() {
  ...
  SPFAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.spf-hidden-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.SPFChosenOrder($hidden_value, true);
  ...
  $.fn.SPFAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new SPFAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, SPFAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  SPFAbstractChosenOrder = (function() {

    function SPFAbstractChosenOrder() {}

    SPFAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    SPFAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    SPFAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    SPFAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    SPFAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    SPFAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    SPFAbstractChosenOrder.SPFChosenOrder = function(select, order, force) {
  ...
  $.fn.extend({
    SPFChosenOrder: function(order, force) {
      return _SPFChosenOrder.SPFChosenOrder(this, order, force);
    }
  });

  this._SPFChosenOrder = (function(_super) {
    __extends(_SPFChosenOrder, _super);

    function _SPFChosenOrder() {
      _ref = _SPFChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _SPFChosenOrder.relAttributeName = 'data-option-array-index';

    _SPFChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _SPFChosenOrder.getDOMElement = function(element) {
    ...
    _SPFChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _SPFChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _SPFChosenOrder;

  })(SPFAbstractChosenOrder);
