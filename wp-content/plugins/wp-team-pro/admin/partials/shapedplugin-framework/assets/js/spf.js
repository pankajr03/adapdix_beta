...
(function($, window, document, undefined) {
  ...
  spf.helper = {
    ...
    name_nested_replace: function($selector, field_id) {
      ...
      var regex = new RegExp(
        "(" + spf.helper.preg_quote(field_id) + ")\\[(\\d+)\\]",
        "g"
      );
  ...
  $.fn.spf_dependency = function() {
    return this.each(function() {
      ...
      if( depends.length ) {
        ...
        if( is_global ) {
          $.spf_deps.enable(spf.vars.$body, ruleset, depends);
        } else {
    ...
    return this.each(function() {
      ...
      $this.on("click", ".spf-icon-add", function(e) {
        ...
        if (!spf.vars.icon_modal_loaded) {
          ...
          window.wp.ajax.post( 'spf-get-icons', {
          ...
          $this.on(
            ...
            spf.helper.debounce(function(event) {
              ...
              var font_family = $font_family_select.val(),
                ...
                margin_top = $this.find('.spf--margin-top').val(),
                margin_bottom = $this.find('.spf--margin-bottom').val();
              ...
              // }
              if (letter_spacing) {
                properties.letterSpacing = letter_spacing;
              }
              if (word_spacing) {
              ...
              if (margin_top) {
                properties.marginTop = margin_top + unit;
              }
              if (margin_bottom) {
                properties.marginBottom = margin_bottom + unit;
              }
  ...
  $.fn.spf_field_wp_editor = function() {
    return this.each( function() {
      ...
      var uid = spf.helper.uid('spf-editor-');
      ...
      var editor_on_change = function( editor ) {
        editor.on('change', spf.helper.debounce( function() {
          editor.save();
  ...
  $.fn.spf_shortcode = function() {
    ...
    return this.each(function() {
      ...
      $insert.on("click", function(e) {
        ...
        var shortcode = "";
        var serialize = $modal.find('.spf-field:not(.hidden)').find(':input:not(.ignore)').serializeObjectSPF();
    ...
    return this.each( function() {
      ...
      if( $inited.length ) {
        ...
        if( is_multiple ) {
          ...
          $this.SPFChosenOrder($hidden_value, true);
  ...
  $.fn.spf_customizer_listen = function(options) {
    ...
    return this.each(function() {
      ...
      $input.on(
        "change keyup",
        spf.helper.debounce(function() {
          var obj = $this.find(":input").serializeObjectspf();
  ...
  $(document).on('expanded', '.control-section', function() {
    ...
    if( $this.hasClass('open') && !$this.data('inited') ) {
      ...
      var $fields  = $this.find('.spf-customize-field');
      var $complex = $this.find('.spf-customize-complex');

      if( $fields.length ) {
        $this.spf_dependency();
        $fields.spf_reload_script({dependency: false});
        $complex.spf_customizer_listen();
      }
