 ...
 * @version 2.0
 */
if ( ! class_exists( 'SPF_Field_switcher' ) ) {
	class SPF_Field_switcher extends SPF_Fields {
		...
		public function render() {
			...
			$text_on    = ( ! empty( $this->field['text_on'] ) ) ? $this->field['text_on'] : esc_html__( 'On', 'spf' );
			$text_off   = ( ! empty( $this->field['text_off'] ) ) ? $this->field['text_off'] : esc_html__( 'Off', 'spf' );
