 ...
 * @version 2.0
 */
if ( ! class_exists( 'SPF_Field_media' ) ) {
	class SPF_Field_media extends SPF_Fields {
		...
		public function render() {
			...
			$placeholder = ( empty( $this->field['placeholder'] ) ) ? ' placeholder="' . esc_html__( 'No media selected', 'spf' ) . '"' : '';
