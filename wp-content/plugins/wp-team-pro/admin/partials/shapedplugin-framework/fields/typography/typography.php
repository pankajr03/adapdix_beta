	...
	class SPF_Field_typography extends SPF_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['text_align'] ) ) {
				...
				echo $this->create_select(
					array(
						'inherit' => esc_html__( 'Inherit', 'spf' ),
						'left'    => esc_html__( 'Left', 'spf' ),
						'center'  => esc_html__( 'Center', 'spf' ),
						'right'   => esc_html__( 'Right', 'spf' ),
						'justify' => esc_html__( 'Justify', 'spf' ),
						'initial' => esc_html__( 'Initial', 'spf' ),
					),
					'text-align',
					esc_html__( 'Default', 'spf' )
				);
			...
			if ( ! empty( $args['font_variant'] ) ) {
				...
				echo $this->create_select(
					array(
						...
						'small-caps'     => esc_html__( 'Small Caps', 'spf' ),
						'all-small-caps' => esc_html__( 'All Small Caps', 'spf' ),
					),
					'font-variant',
					esc_html__( 'Default', 'spf' )
				);
			...
			if ( ! empty( $args['text_transform'] ) ) {
				...
				echo $this->create_select(
					array(
						...
						'capitalize' => esc_html__( 'Capitalize', 'spf' ),
						'uppercase'  => esc_html__( 'Uppercase', 'spf' ),
						'lowercase'  => esc_html__( 'Lowercase', 'spf' ),
					),
					'text-transform',
					esc_html__( 'Default', 'spf' )
				);
			...
			if ( ! empty( $args['text_decoration'] ) ) {
				...
				echo $this->create_select(
					array(
						'none'               => esc_html__( 'None', 'spf' ),
						'underline'          => esc_html__( 'Solid', 'spf' ),
						'underline double'   => esc_html__( 'Double', 'spf' ),
						'underline dotted'   => esc_html__( 'Dotted', 'spf' ),
						'underline dashed'   => esc_html__( 'Dashed', 'spf' ),
						'underline wavy'     => esc_html__( 'Wavy', 'spf' ),
						'underline overline' => esc_html__( 'Overline', 'spf' ),
						'line-through'       => esc_html__( 'Line-through', 'spf' ),
					),
					'text-decoration'
				);
				echo '</div>';
			...
			if ( ! wp_style_is( 'spf-webfont-loader' ) ) {
				...
				if ( ! empty( $customwebfonts ) ) {
					$webfonts['custom'] = array(
						'label' => esc_html__( 'Custom Web Fonts', 'spf' ),
						'fonts' => $customwebfonts,
					);
				}

				$webfonts['safe'] = array(
					'label' => esc_html__( 'Safe Web Fonts', 'spf' ),
					'fonts' => apply_filters(
				...
				$webfonts['google'] = array(
					'label' => esc_html__( 'Google Web Fonts', 'spf' ),
					'fonts' => apply_filters(
