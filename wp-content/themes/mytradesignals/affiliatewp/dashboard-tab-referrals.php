<div id="affwp-affiliate-dashboard-referrals" class="table-responsive affwp-tab-content">
...
<div id="affwp-affiliate-dashboard-referrals" class="table-responsive affwp-tab-content">
	<h4 class="DirectReferrals">Direct Referrals</h4>
